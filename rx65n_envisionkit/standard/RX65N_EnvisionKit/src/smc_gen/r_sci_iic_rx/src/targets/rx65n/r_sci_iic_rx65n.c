 ...
 * Return Value : None
 **********************************************************************************************************************/
            #pragma interrupt (sci_iic_int_sci_iic8_txi_isr(vect=VECT_SCI8_TXI8))
static void sci_iic_int_sci_iic8_txi_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
            #pragma interrupt (sci_iic_int_sci_iic9_txi_isr(vect=VECT_SCI9_TXI9))
static void sci_iic_int_sci_iic9_txi_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
            #pragma interrupt (sci_iic_int_sci_iic10_txi_isr(vect=VECT_SCI10_TXI10))
static void sci_iic_int_sci_iic10_txi_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
            #pragma interrupt (sci_iic_int_sci_iic11_txi_isr(vect=VECT_SCI11_TXI11))
static void sci_iic_int_sci_iic11_txi_isr (void)
{
