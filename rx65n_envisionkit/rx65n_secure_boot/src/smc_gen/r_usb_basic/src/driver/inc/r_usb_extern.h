...
extern void R_USB_HcdcTask (usb_vp_int_t stacd);
extern void R_USB_HcdcDriverStart (void);
...
extern void R_USB_HhidTask (usb_vp_int_t stacd);
extern void R_USB_HhidDriverStart (usb_utr_t *ptr);
...
extern void R_USB_HmscDriverStart (uint16_t ip_no);
extern void R_USB_HmscTask (void);
extern void R_USB_HmscStrgDriveTask (void);
extern uint16_t R_USB_HmscStrgDriveSearch (usb_utr_t *ptr, uint16_t addr, usb_cb_t complete);
