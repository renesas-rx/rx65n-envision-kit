...
#if SECURE_BOOT
    { __sectop("D_STDLIB"), __secend("D_STDLIB"), __sectop("R_STDLIB") },
    { __sectop("D_STDLIB_1"), __secend("D_STDLIB_1"), __sectop("R_STDLIB_1") },
    { __sectop("D_STDLIB_2"), __secend("D_STDLIB_2"), __sectop("R_STDLIB_2") },
    { __sectop("DSECURE_BOOT"), __secend("DSECURE_BOOT"), __sectop("RSECURE_BOOT") },
    { __sectop("DSECURE_BOOT_1"), __secend("DSECURE_BOOT_1"), __sectop("RSECURE_BOOT_1") },
    { __sectop("DSECURE_BOOT_2"), __secend("DSECURE_BOOT_2"), __sectop("RSECURE_BOOT_2") },
#endif
};
...
#if SECURE_BOOT
	{ __sectop("BSECURE_BOOT"), __secend("BSECURE_BOOT") },
	{ __sectop("BSECURE_BOOT_1"), __secend("BSECURE_BOOT_1") },
	{ __sectop("BSECURE_BOOT_2"), __secend("BSECURE_BOOT_2") },
#endif
};
