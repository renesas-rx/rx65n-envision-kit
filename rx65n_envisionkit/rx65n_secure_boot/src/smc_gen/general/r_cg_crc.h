...
*/
/* CRC Generating Polynomial Switching (GPS[2:0]) */
...
#define _04_CRC_32                                (0x04U) /* CRC-32 execution */
#define _05_CRC_32C                               (0x05U) /* CRC-32C execution */
/* CRC Calculation Switching (LMS) */
#define _00_CRC_LSB_FIRST                         (0x00U) /* Performs CRC for LSB-first communication */
#define _40_CRC_MSB_FIRST                         (0x40U) /* Performs CRC for MSB-first communication */
